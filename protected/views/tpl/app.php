  ...
  <!-- navbar    data-ng-include=" 'protected/modules/universe/tpl/blocks/header.php' "-->
                  <div  data-ng-include=" 'protected/views/tpl/blocks/header.php' " class="app-header navbar">
                  </div>
                  <!-- / navbar -->

                  <!-- menu -->
                  <div data-ng-include=" 'protected/views/tpl/blocks/aside.php' " class="app-aside hidden-xs {{app.settings.asideColor}}">
                  </div>
                  <!-- / menu -->
      ...
      <div class="row-row">
        <div class="cell">
          <div class="cell-inner padder">
            <!-- chat list -->
            <div class="m-b">
              <a href class="pull-left thumb-xs avatar"><img src="theme/img/a2.jpg" alt="..."></a>
              <div class="clear">
                <div class="pos-rlt wrapper-sm b b-light r m-l-sm">
                  <span class="arrow left pull-up"></span>
                  <p class="m-b-none" id="SessNewHi">Hi ...</p>
                </div>
                <small class="text-muted m-l-sm"><i class="fa fa-ok text-success"></i> 2 minutes ago</small>
              </div>
            </div>
            <div class="m-b">
              <a href class="pull-right thumb-xs avatar"><img src="theme/img/a3.jpg" class="img-circle" alt="..."></a>
              <div class="clear">
  ...
  <div data-ng-include=" 'protected/views/tpl/blocks/settings.php' " class="settings panel panel-default">
  </div>
  
  <script>
   
    $( document ).ready(function() {
     var use_session=session_use;
     $("#SessNewHi").html(use_session);
