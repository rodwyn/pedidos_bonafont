<div class="container w-xxl w-auto-xs" ng-controller="SigninFormController" ng-init="app.settings.container = false;">
  <a href class="navbar-brand block m-t"><i class=""><img src="img/brujula.png" alt="." class=""></i><span class="hidden-folded m-l-xs">{{app.name}}</span></a>
  <div class="m-b-lg">
  ...
  <div class="text-center" ng-include="'protected/modules/universe/tpl/blocks/page_footer.html'"></div>
</div>