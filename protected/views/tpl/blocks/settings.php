<!-- settings -->
  ...
  <div class="panel-body"> 
    ...
    <div class="m-b-sm">
      <label class="i-switch bg-info pull-right">
        <input type="checkbox" ng-model="app.settings.asideFolded" onclick="ChangTitleSoft()">
        <i></i>
      </label>
      Folded aside 
    </div>
  ...
  <div class="wrapper b-t b-light bg-light lter r-b">
    <div class="row row-sm">
      <div class="col-xs-6">
          ...
          app.settings.navbarHeaderColor='bg-bonafont'; 
          app.settings.navbarCollapseColor='bg-white-only'; 
          app.settings.asideColor='bg-bonafont';
         ">
          <input type="radio" name="a" ng-model="app.settings.themeID" value="15">
          <span class="block bg-light clearfix pos-rlt">
            <span class="active pos-abt w-full h-full bg-black-opacity text-center">
              <i class="glyphicon glyphicon-ok text-white m-t-xs"></i>
            </span>
            <b class="bg-bonafont header"></b>
            <b class="bg-white header"></b>
            <b class="bg-bonafont"></b>
          </span>
        </label>
        <label class="i-checks block m-b" ng-click="
