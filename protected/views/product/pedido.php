...
<div ng-controller="listProductController" >
    <div class="col col-sm-8 col-xs-12 bg-white-only" style="border: #FFD324 solid thin;">
    ...
    <div class="col col-sm-4 col-xs-12 bg-white-only" style="border: #0000EE solid thin;">
        <!-- alert -->
        <div  class="m-b-md">
        ...
        <div class="bg-white-only lter b-b wrapper-md">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <h1 class="m-n font-thin h3 text-black">Resumen</h1>
                    <small class="text-muted">Resumen del pedido</small>
                </div>
            </div>
        </div>
        <div class="row">
