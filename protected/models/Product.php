...
class Product extends CActiveRecord {
    ...
    public function getproduct() {
        ...
        $criteria->select = "t.productid, c.name as marca, t.name as dsc, t.listprice, s.stock, t.image";
        $criteria->join = "inner join category c on c.categoryid = t.categoryid
                           inner join stock s on s.productid=t.productid and s.companyid = ".Yii::app()->user->companyid;
